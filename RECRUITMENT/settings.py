...
ALLOWED_HOSTS = ["recruits.up.railway.app", "https://127.0.0.1", "caverecruits.com"]

SECRET_KEY = config('SECRET_KEY')

CSRF_TRUSTED_ORIGINS = ['https://recruits.up.railway.app','https://127.0.0.1', "caverecruits.com"]
...
SENDGRID_API_KEY = config("BEST_SENDGRID_KEY")
